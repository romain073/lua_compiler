...
exp : TRUE                      {/* $$=new Node("value", "true"); */}
    ...
    | exp LT exp                { $$=new Comparison($1, $3, Comparison::Operation::LT);}
    | exp LTE exp               { $$=new Comparison($1, $3, Comparison::Operation::LE);}
    | exp GT exp                { $$=new Comparison($1, $3, Comparison::Operation::GT);}
    | exp GTE exp               { $$=new Comparison($1, $3, Comparison::Operation::GE);}
    | exp EQ exp                { $$=new Comparison($1, $3, Comparison::Operation::EQ);}
    | exp NE exp                { $$=new Comparison($1, $3, Comparison::Operation::NE);}
